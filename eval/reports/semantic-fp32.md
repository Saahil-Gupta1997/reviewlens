...
- Generated: 2026-09-12T15:59:46.777Z
...
| --- | --- | --- | --- | --- | --- | --- |
| lexical-baseline | 0.200 | 0.180 | 0.400 | 0.00 | 0.4 | 6.4 |
| on-device-semantic | 0.200 | 0.300 | 0.400 | 0.50 | n/a | n/a |

- Timing (lexical-baseline): Measured in-process lexical search; excludes network and UI.
- Timing (on-device-semantic): Not measured: no paired browser timing metadata supplied.
...
| p95_latency_ms | <= 1500 | n/a | NOT_MEASURED |
