...
- Generated: 2026-09-12T15:59:46.672Z
...
| --- | --- | --- | --- | --- | --- | --- |
| lexical-baseline | 0.200 | 0.180 | 0.400 | 0.00 | 0.3 | 6.3 |
| on-device-semantic | 0.267 | 0.320 | 0.400 | 0.50 | 31.0 | 38.0 |

- Timing (lexical-baseline): Measured in-process lexical search; excludes network and UI.
- Timing (on-device-semantic): Elapsed browser worker search request through response after indexing; includes query embedding, index read/validation, ranking and message round-trip; excludes initial download/indexing. Captured 2026-09-12T11:07:38.475Z; Chrome 152.0.7977.76 (Windows NT 10.0 Win64 x64). One sample per case; not a load-test percentile.
...
| --- | --- | --- | --- |
| recall_at_5 | >= 0.7 | 0.267 | FAIL |
| precision_at_5 | >= 0.5 | 0.320 | FAIL |
| absent_topic_false_positive_rate | <= 0.25 | 0.500 | FAIL |
| p95_latency_ms | <= 1500 | 38.000 | PASS |

## Per-case detail - on-device-semantic

| Case | Category | Question | Relevant | Retrieved | R@5 | P@5 | Missed | Spurious |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| D1 | paraphrase | Which customers are locked out of their accounts? | 5 | 3 | 0.00 | 0.00 | VAL-013 VAL-014 VAL-015 VAL-017 VAL-018 | VAL-020 VAL-004 VAL-012 |
| D2 | paraphrase | Does anything take a long time to appear on screen? | 3 | 5 | 1.00 | 0.60 | - | VAL-005 VAL-011 |
