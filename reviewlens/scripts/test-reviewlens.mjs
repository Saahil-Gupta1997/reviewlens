...
const r=spawnSync(process.execPath,['--test','tests/reviewlens-engine.test.mjs','tests/reviewlens-api.test.mjs','tests/device-search.test.mjs'],{stdio:'inherit'});process.exit(r.status??1);
