...
| ISS-08 | The worker mapped any unrecognised error to "check your connection", reporting a code defect as a network problem | A wrong diagnosis propagated into every project document for three weeks | **Closed 2026-09-12.** Diagnosis extracted to `describeFailure()`, which explains only recognised conditions and carries the real message otherwise. 4 tests, including the exact SyntaxError that fooled the project | — |
