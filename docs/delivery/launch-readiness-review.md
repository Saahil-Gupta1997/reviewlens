...
| On-device semantic search - MiniLM in a browser worker | **NO-GO, now on measured evidence.** Stays off by default | Ran on Chrome 152 on 2026-09-12 after fixing a load defect, then **missed its gate on 3 of 4 bounds**: recall@5 0.267 vs 0.70, precision@5 0.320 vs 0.50, absent-topic FP 0.50 vs 0.25. A sweep of every threshold clears none ([result](evaluation-semantic-result.md)) |
